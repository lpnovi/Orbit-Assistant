...
- **Orbit Extensions:** Install official first-party extensions directly inside Orbit, or import custom reviewed `.orbitext` files. Both add only safe Open URL and bounded HTTPS actions to Routines without loading arbitrary code or accessing Orbit personal data.
